    ...
    public class Game
    {
        ...
        public void PlayTurn()
        {
            ...
            while (player1card.Value == player2card.Value)
            {
                ...
                if(Player2.Deck.Count < warturncount + 1)
                {
                ...
                if (Player1.Deck.Count < warturncount + 1)
                {
                    TestDeck(Player1, Player2, pool);
                    Player1.Deck.Clear();
                    return;
                ...
                for(int i = 0; i <= warturncount; i++) // Everytime a war occurs, add a card facedown to the pool
                {
